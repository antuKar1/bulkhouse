    ...
    <div className="card card-compact  bg-base-100 shadow-xl">
        ...
        <div className="card-body">
          ...
          <div className="card-actions justify-around items-center mt-5">
            <Link to={`edit/${id}`}  className='text-2xl tooltip tooltip-bottom'data-tip="Edit" ><MdEditLocationAlt /></Link>
            <Link className="btn bg-zinc-900 text-slate-300 " to={`/productDetails/${id}`}>View Details</Link>
            <Link onClick={deleteProduct}  className='text-2xl tooltip tooltip-bottom'data-tip="Delete"><MdAutoDelete /></Link>
